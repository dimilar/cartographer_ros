                      ...
                      (cond ((eq system-type 'darwin)
                             (setq include-dirs
                                   `(,(concat project-dir "")
                                     ...
                                     "/usr/local/include"))
                             (setq clang-args '("-std=c++11" "-stdlib=libc++" "-DBOOST_NO_EXCEPTIONS" "-DQT_CORE_LIB" "-DQT_GUI_LIB" "-DQT_NO_DEBUG" "-DQT_NO_KEYWORDS" "-DROSCONSOLE_BACKEND_LOG4CXX" "-DROS_PACKAGE_NAME=\"cartographer_rviz\"" "-Dcartographer_rviz_submaps_visualization_EXPORTS" "-isysroot" "/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk" "-iframework" "/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/System/Library/Frameworks" "-isystem" "/usr/local/Cellar/qt/4.8.7_2/include" "-iframework" "/usr/local/Cellar/qt/4.8.7_2/lib" "-isystem" "/usr/local/Cellar/qt/4.8.7_2/include/QtGui" "-isystem" "/usr/local/Cellar/qt/4.8.7_2/lib/QtCore.framework/Headers")))
